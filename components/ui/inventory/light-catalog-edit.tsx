...
const LightCatalogEditDialog: React.FC<LightCatalogEditDialogProps> = ({ inventory, onUpdateSuccess, onDeleteSuccess }) => {
  ...
  const handleSave = async () => {
    try {
      const response = await fetch(`/api/inventory/light-catalog?id=${uniqueId}`, { // Use unique ID in URL
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}> {/* Manage open state */}
      ...
      <DialogContent className='w-[800px] sm:max-w-[425px] md:max-w-full'>
        ...
        <div className='grid gap-4 py-4'>
          <div className='grid grid-cols-2 gap-8'>
            <div className='grid grid-cols-4 items-center gap-4'>
              ...
              <Input id='tag' value={tag} className='col-span-3' onChange={(e) => setTag(e.target.value)}/>
            </div>
            <div className='grid grid-cols-4 items-center gap-4'>
        ...
        <DialogFooter>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Weet je zeker dat je wilt verwijderen?</AlertDialogTitle>
                <AlertDialogDescription>
                  Deze actie kan niet ongedaan gemaakt worden. Dit zal de lamp permanent verwijderen.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
