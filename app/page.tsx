    ...
    <main className='flex min-h-screen flex-col p-6'>
      <div className='flex h-20 shrink-0 items-end rounded-lg bg-[#0066CC] p-4 md:h-52'>
        <Image
          ...
          height={60}
          alt='JL Penta logo'
          className='h-auto w-auto object-contain pl-4'
        />
      </div>
      <div className='mt-4 flex grow flex-col gap-4 md:flex-row'>
        <div className='flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20'>
          <p className='text-xl text-gray-800 md:text-3xl md:leading-normal'>
            <strong>
              Welkom bij het Techniek Team van
              <br />
            </strong>
            <a href='https://jl.penta.nl' className='text-[#0066CC]'>
        ...
        <div className='relative flex items-center justify-center p-6 md:w-3/5'>
          ...
          <Image
            ...
            width={550}
            height={416}
            className='absolute left-5 top-5 z-10 rounded-lg object-cover'
